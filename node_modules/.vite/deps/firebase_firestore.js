          ...
          if (!(k2 < 3) && (k2 != 3 || this.g && (this.h.h || this.g.la() || Ib(this.g)))) {
            ...
            if (this.o) {
              ...
              if (this.R) {
                ...
                this.o = this.o && a;
                if (!a)
                  K2(this.i, this.l, c, "[Invalid Chunked Response]"), Q2(this), Mb(this);
...
var __PRIVATE_IndexedDbDocumentOverlayCache = class {
  ...
  getOverlaysForCollection(e, t, n) {
    const r = __PRIVATE_newOverlayMap(), i = __PRIVATE_encodeResourcePath(t), s = IDBKeyRange.bound([this.userId, i, n], [this.userId, i, Number.POSITIVE_INFINITY], true);
...
var __PRIVATE_IndexedDbIndexManager = class {
  ...
  getCollectionParents(e, t) {
    const n = [], r = IDBKeyRange.bound([t, ""], [__PRIVATE_immediateSuccessor(t), ""], false, true);
  ...
  Bn(e, t, n, r, i, s, o) {
    ...
    for (let c = 0; c < _; ++c) {
      const _2 = t ? this.Ln(t[c / a]) : Mt, l = this.kn(e, _2, n[c % a], r), h = this.qn(e, _2, i[c % a], s), P = o.map((t2) => this.kn(e, _2, t2, true));
...
var __PRIVATE_IndexedDbTargetCache = class {
  ...
  removeMatchingKeysForTargetId(e, t) {
    const n = __PRIVATE_documentTargetStore(e), r = IDBKeyRange.bound([t], [t + 1], false, true);
    return n.delete(r);
  }
  getMatchingKeysForTargetId(e, t) {
    const n = IDBKeyRange.bound([t], [t + 1], false, true), r = __PRIVATE_documentTargetStore(e);
  ...
  containsKey(e, t) {
    const n = __PRIVATE_encodeResourcePath(t.path), r = IDBKeyRange.bound([n], [__PRIVATE_immediateSuccessor(n)], false, true);
    let i = 0;
...
function __PRIVATE_localStoreGetNewDocumentChanges(e, t) {
  ...
  return n.persistence.runTransaction("Get new document changes", "readonly", (e2) => n.Ns.getAllFromCollectionGroup(e2, t, __PRIVATE_newIndexOffsetSuccessorFromReadTime(r, U), Number.MAX_SAFE_INTEGER)).then((e2) => (__PRIVATE_setMaxReadTime(n, t, e2), e2));
}
...
var __PRIVATE_View = class {
  ...
  applyChanges(e, t, n, r) {
    ...
    if (this.Za = _, 0 !== s.length || a) {
      return {
        snapshot: new ViewSnapshot(this.query, e.tu, i, s, e.mutatedKeys, 0 === _, a, false, !!n && n.resumeToken.approximateByteSize() > 0),
        au: o
      };
    }
    return {
...
async function __PRIVATE_initializeViewAndComputeSnapshot(e, t, n, r, i) {
  e.pu = (t2, n2, r2) => async function __PRIVATE_applyDocChanges(e2, t3, n3, r3) {
    ...
    const s2 = r3 && r3.targetChanges.get(t3.targetId), o2 = r3 && null != r3.targetMismatches.get(t3.targetId), _2 = t3.view.applyChanges(i2, e2.isPrimaryClient, s2, o2);
    return __PRIVATE_updateTrackedLimbos(e2, t3.targetId, _2.au), _2.snapshot;
  }(e, t2, n2, r2);
  const s = await __PRIVATE_localStoreExecuteQuery(e.localStore, t, true), o = new __PRIVATE_View(t, s.Qs), _ = o.ru(s.documents), a = TargetChange.createSynthesizedTargetChangeForCurrentChange(n, r && "Offline" !== e.onlineState, i), u = o.applyChanges(_, e.isPrimaryClient, a);
...
async function __PRIVATE_syncEngineRejectListen(e, t, n) {
  ...
  if (s) {
    ...
    const n2 = __PRIVATE_documentKeySet().add(s), i2 = new RemoteEvent(SnapshotVersion.min(), /* @__PURE__ */ new Map(), new SortedMap(__PRIVATE_primitiveComparator), e2, n2);
...
async function __PRIVATE_synchronizeViewAndComputeSnapshot(e, t) {
  const n = __PRIVATE_debugCast(e), r = await __PRIVATE_localStoreExecuteQuery(n.localStore, t.query, true), i = t.view.cu(r);
...
async function __PRIVATE_syncEngineApplyActiveTargetsChange(e, t, n) {
  ...
  if (r.gu) {
    ...
    for (const e2 of n)
      r.Iu.has(e2) && await __PRIVATE_localStoreReleaseTarget(r.localStore, e2, false).then(() => {
...
function __PRIVATE_syncEngineLoadBundle(e, t, n) {
  ...
  (async function __PRIVATE_loadBundleImpl(e2, t2, n2) {
    try {
      ...
      return await __PRIVATE_syncEngineEmitNewSnapsAndNotifyLocalStore(e2, o.Ha, void 0), await function __PRIVATE_localStoreSaveBundle(e3, t3) {
...
function __PRIVATE_firestoreClientGetDocumentsFromLocalCache(e, t) {
  ...
  return e.asyncQueue.enqueueAndForget(async () => async function __PRIVATE_executeQueryFromCache(e2, t2, n2) {
    try {
      const r = await __PRIVATE_localStoreExecuteQuery(e2, t2, true), i = new __PRIVATE_View(t2, r.Qs), s = i.ru(r.documents), o = i.applyChanges(s, false);
  ...
  return e.asyncQueue.enqueueAndForget(async () => {
    try {
      ...
      r.resolve(async function __PRIVATE_invokeRunAggregationQueryRpc(e2, t2, n2) {
        ...
        const _ = (await r2.Ho("RunAggregationQuery", r2.serializer.databaseId, o, i2, 1)).filter((e3) => !!e3.result);
...
var __PRIVATE_ArrayUnionFieldValueImpl = class extends FieldValue {
  ...
  _toFieldTransform(e) {
    const t = __PRIVATE_createSentinelChildContext(this, e, true), n = this.vc.map((e2) => __PRIVATE_parseData(e2, t)), r = new __PRIVATE_ArrayUnionTransformOperation(n);
...
var __PRIVATE_ArrayRemoveFieldValueImpl = class extends FieldValue {
  ...
  _toFieldTransform(e) {
    const t = __PRIVATE_createSentinelChildContext(this, e, true), n = this.vc.map((e2) => __PRIVATE_parseData(e2, t)), r = new __PRIVATE_ArrayRemoveTransformOperation(n);
    return new FieldTransform(e.path, r);
  }
  isEqual(e) {
...
function __PRIVATE_fieldPathFromDotSeparatedString(e, t, n) {
  if (t.search(Pn) >= 0)
    throw __PRIVATE_createError(`Invalid field path (${t}). Paths must not contain '~', '*', '/', '[', or ']'`, e, false, void 0, n);
  try {
  ...
  _parse(e) {
    const t = __PRIVATE_newUserDataReader(e.firestore), n = function __PRIVATE_newQueryFilter(e2, t2, n2, r, i, s, o) {
      ...
      if (i.isKeyField()) {
        ...
        "in" !== s && "not-in" !== s && "array-contains-any" !== s || __PRIVATE_validateDisjunctiveFilterElements(o, s), _ = __PRIVATE_parseQueryValue(n2, t2, o, "in" === s || "not-in" === s);
...
function documentSnapshotFromJSON(e, t, n) {
  if (__PRIVATE_validateJSON(t, DocumentSnapshot._jsonSchema)) {
    ...
    return new DocumentSnapshot(e, new __PRIVATE_LiteUserDataWriter(e), u, a, new SnapshotMetadata(false, false), n || null);
  }
}
...
function querySnapshotFromJSON(e, t, n) {
  if (__PRIVATE_validateJSON(t, QuerySnapshot._jsonSchema)) {
    ...
    const c = ViewSnapshot.fromInitialDocuments(_, u, __PRIVATE_documentKeySet(), false, false), l = new Query(e, n || null, _);
